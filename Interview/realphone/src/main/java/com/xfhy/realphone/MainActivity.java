...
import com.xfhy.realphone.adapter.ContactsListAdapter;
import com.xfhy.realphone.entity.Person;
        ...
        switch (requestCode) {
            case 1:
                if (grantResults.length>0 && grantResults[0]==PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "您没有允许应用权限！无法进行通讯录的读取。", Toast.LENGTH_SHORT).show();
                    finish();
                }
                break;
            default:
