...
public abstract class SectionedRecyclerViewAdapter<RH extends RecyclerView.ViewHolder, H extends
    ...
    private int countItems() {
        ...
        for (int i = 0; i < sections; i++) {
            ...
            count += itemCountForSection; //那个组内的item个数
    ...
    public int getItemViewType(int position) {
        ...
        if (emptyViewVisible) {
            ...
            if (hasHeader()) {
                ...
                } else if (position < getItemCount()) {//xxxxxxx
                ...
                if (position < getItemCount()) { //xxxxxxx
